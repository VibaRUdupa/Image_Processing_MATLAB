...
%for my original picture, blue image had maximum contrast.

max_contrast_image = blue;
...
imshow(binary_image)
title('Binary image')
%as the ball in my image is white shaded, I am not complementing it.
%ignore next section
...
clear_border_image = imclearborder( binary_image );
subplot( 2 , 2 , 1);
